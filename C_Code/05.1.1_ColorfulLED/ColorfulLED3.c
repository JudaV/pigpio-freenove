/*
 * Filename: ColorfullLED3.c
 * Project: Freenove kit using pigpio C and Python library
 * Description: random color change in colorfull LED
 * Author: JudaV
 * date: october 2024
 * compile:     gcc -o ColorfullLED3 ColorfullLED3.c -lrt -lpigpio -lpthread
 * usage:       sudo ./ColorfullLED3
 */
