/*
 * Filename:    Doorbell3.c
 * Project:     Freenove kit using pigpio C and Python library
 * Description: making a door bell with a button and buzzer
 * Author:      JudaV
 * date:        october 2024
 * compile:     gcc -o Doorbell3 Doorbell3.c -lrt -lpigpio -lpthread
 * usage:       sudo ./Doorbell3
 */
