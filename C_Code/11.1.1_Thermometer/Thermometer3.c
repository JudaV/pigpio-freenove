/*
 * Filename:    Thermometer3.c
 * Project:     Freenove kit using pigpio C and Python library
 * Description: use of 8591 ADC chip to read the temparature from a thermistor
 * Author:      JudaV
 * date:        october 2024
 * compile:     sudo apt-get install libncurses5-dev
 *              gcc -o Thermometer3 Thermometer3.c -lcurses -lpigpio -lpthread -lm
 * usage:       sudo ./Thermometer3
 */
