/*
 * Filename:    SteppingMotor3.c
 * Project:     Freenove kit using pigpio C and Python library
 * Description: use of a stepping motor
 * Author:      JudaV
 * date:        october 2024
 * compile:     gcc -o SteppingMotor3 SteppingMotor3.c -lcurses -lpigpio -lpthread
 *              or with Makefile:  make
 * usage:       sudo ./SteppingMotor3
 */
