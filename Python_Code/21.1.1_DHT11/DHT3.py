...
class sensor:
    ...
    def _validate_DHT11(self, b1, b2, b3, b4):
        ...
        # I changed b1==0 to b1<10 because my ASAIR DHT11 reads this way apparantly
        # (b1 is is decimal of temperature, e.g 20.8 instead of 20)
        if (b1 < 10) and (b3 == 0) and (t <= 60) and (h >= 9) and (h <= 90):
            valid = True
        else:
            valid = False
        return (valid, t, h)
...
if __name__ == "__main__":
    ...
    # Instantiate a class for GPIO pin
    s = sensor(pi, PIN, model=DHT11)
