...
def setColor(r_val,g_val,b_val):      # change duty cycle for three pins to r_val,g_val,b_val
    pwmRed.ChangeDutyCycle(100-r_val)     # change pwmRed duty cycle to r_val
    pwmGreen.ChangeDutyCycle(100-g_val)
    pwmBlue.ChangeDutyCycle(100-b_val)

def loop():
    while True :
        #r=random.randint(0,101,100)  #get a random in (0,100)
        r= 100
        #g=random.randint(0,101,100)
        g = 30
        #b=random.randint(0,101,100)
        b= 0
